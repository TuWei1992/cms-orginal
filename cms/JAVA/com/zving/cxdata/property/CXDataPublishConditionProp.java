 ...
 * 栏目属性扩展项，选择数据按条件发布
 */
public class CXDataPublishConditionProp extends AbstractProperty {
	public static final String ID = "CXDataPublishConditionProp";
	public static final String NAME = "发布条件";
	@Override
