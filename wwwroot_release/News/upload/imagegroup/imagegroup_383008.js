...
function getUrlParameterAdv(){
	path = document.getElementById('imagegroupjs_383008').getAttribute("path")
 }
...
var images = ["upload/gnxw/tp/1902375.jpg","upload/gnxw/tp/1910.jpg","upload/gnxw/tp/1928128.jpg","upload/gnxw/tp/1935754.jpg","upload/gnxw/tp/1942877.jpg","upload/gnxw/tp/195503.jpg","upload/gnxw/tp/1962648.jpg","upload/gnxw/tp/197274.jpg"];
var info = ["","","","","","","","查韦斯的形象出现在委内瑞拉的各个角落，红色反美斗士形象在其支持者中深入人心。"];
var title = "在委内瑞拉的各个角落都有查韦斯的形像";
initDiv(document.getElementById('imagegroupjs_383008'),images,info,"",title);

document.getElementById('imagegroupjs_383008').innerHTML=document.getElementById('imagegroupjs_383008').innerHTML+"<script type='text/javascript'>	galleryScroll({		changeObj : '.bigimg_wrap .bigimg',		changeObj_wrap:'.bigimg_wrap',		thumbObj_wrap:'.img-thumbs',  		thumbObj : 'ul.img-thumb-list li',		botPrev : '.img_gallery_wrap .sprev',		botNext : '.img_gallery_wrap .snext',		description:'div.bigimg_description',		allowObj:'div.img_gallery_con',		imgcurNum:'span.img_gallery_num',		thumbPrev:'div.img_back',		thumbNext:'div.img_forward',		autoChangeObj: 'div.img_gallery_tipWrap span'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_383008').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_383008').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_383008').getElementsByTagName('script')[0].text);
}
},1000);
