...
function getUrlParameterAdv(){
	path = document.getElementById('imagegroupjs_383006').getAttribute("path")
 }
...
var images = ["upload/gnxw/tp/1739635.jpg","upload/gnxw/tp/1747260.jpg","upload/gnxw/tp/1754384.jpg","upload/gnxw/tp/1762009.jpg","upload/gnxw/tp/177137.jpg","upload/gnxw/tp/1787763.jpg","upload/gnxw/tp/1794886.jpg"];
var info = ["","","","埃及过渡期更需包容力,埃及的动荡仍在延续,目前似乎还不见尽头。","","",""];
var title = "过渡期的埃及";
initDiv(document.getElementById('imagegroupjs_383006'),images,info,"",title);

document.getElementById('imagegroupjs_383006').innerHTML=document.getElementById('imagegroupjs_383006').innerHTML+"<script type='text/javascript'>	galleryScroll({		changeObj : '.bigimg_wrap .bigimg',		changeObj_wrap:'.bigimg_wrap',		thumbObj_wrap:'.img-thumbs',  		thumbObj : 'ul.img-thumb-list li',		botPrev : '.img_gallery_wrap .sprev',		botNext : '.img_gallery_wrap .snext',		description:'div.bigimg_description',		allowObj:'div.img_gallery_con',		imgcurNum:'span.img_gallery_num',		thumbPrev:'div.img_back',		thumbNext:'div.img_forward',		autoChangeObj: 'div.img_gallery_tipWrap span'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_383006').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_383006').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_383006').getElementsByTagName('script')[0].text);
}
},1000);
