...
function getUrlParameterAdv(){
	path = document.getElementById('imagegroupjs_383005').getAttribute("path")
 }
...
var images = ["upload/gnxw/tp/1658630.jpg","upload/gnxw/tp/1666256.jpg","upload/gnxw/tp/1673379.jpg","upload/gnxw/tp/1681005.jpg","upload/gnxw/tp/1699133.jpg","upload/gnxw/tp/1706758.jpg","upload/gnxw/tp/1713881.jpg","upload/gnxw/tp/1721507.jpg"];
var info = ["","西班牙斗牛士何塞·托马斯出现在斗牛场,为观众献艺。 这是一位在西班牙家喻户晓的人物,也是一位毁誉参半的人物。","","","","","",""];
var title = "斗牛士的归来";
initDiv(document.getElementById('imagegroupjs_383005'),images,info,"",title);

document.getElementById('imagegroupjs_383005').innerHTML=document.getElementById('imagegroupjs_383005').innerHTML+"<script type='text/javascript'>	galleryScroll({		changeObj : '.bigimg_wrap .bigimg',		changeObj_wrap:'.bigimg_wrap',		thumbObj_wrap:'.img-thumbs',  		thumbObj : 'ul.img-thumb-list li',		botPrev : '.img_gallery_wrap .sprev',		botNext : '.img_gallery_wrap .snext',		description:'div.bigimg_description',		allowObj:'div.img_gallery_con',		imgcurNum:'span.img_gallery_num',		thumbPrev:'div.img_back',		thumbNext:'div.img_forward',		autoChangeObj: 'div.img_gallery_tipWrap span'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_383005').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_383005').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_383005').getElementsByTagName('script')[0].text);
}
},1000);
