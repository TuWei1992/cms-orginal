...
function getUrlParameterAdv(){
	path = document.getElementById('imagegroupjs_382992').getAttribute("path")
 }
...
var images = ["upload/gnxw/tp/1483443.jpg","upload/gnxw/tp/1491571.jpg","upload/gnxw/tp/1509197.jpg","upload/gnxw/tp/1516320.jpg","upload/gnxw/tp/1523946.jpg","upload/gnxw/tp/1534613.jpg","upload/gnxw/tp/1542238.jpg","upload/gnxw/tp/1559362.jpg"];
var info = ["","","","","","农村的青壮年外出谋生，留守老人独自生活，她们还留守在农村，在对子女的期盼和思念中生活。","",""];
var title = "农村的青壮年外出谋生，留守老人独自生活";
initDiv(document.getElementById('imagegroupjs_382992'),images,info,"",title);

document.getElementById('imagegroupjs_382992').innerHTML=document.getElementById('imagegroupjs_382992').innerHTML+"<script type='text/javascript'>	galleryScroll({		changeObj : '.bigimg_wrap .bigimg',		changeObj_wrap:'.bigimg_wrap',		thumbObj_wrap:'.img-thumbs',  		thumbObj : 'ul.img-thumb-list li',		botPrev : '.img_gallery_wrap .sprev',		botNext : '.img_gallery_wrap .snext',		description:'div.bigimg_description',		allowObj:'div.img_gallery_con',		imgcurNum:'span.img_gallery_num',		thumbPrev:'div.img_back',		thumbNext:'div.img_forward',		autoChangeObj: 'div.img_gallery_tipWrap span'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_382992').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_382992').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_382992').getElementsByTagName('script')[0].text);
}
},1000);
