...
function getUrlParameterAdv(){
	path = document.getElementById('imagegroupjs_383007').getAttribute("path")
 }
...
var images = ["upload/gnxw/tp/1806622.jpg","upload/gnxw/tp/1814247.jpg","upload/gnxw/tp/1821371.jpg","upload/gnxw/tp/1838996.jpg","upload/gnxw/tp/1847124.jpg","upload/gnxw/tp/1854749.jpg","upload/gnxw/tp/1861873.jpg","upload/gnxw/tp/1879498.jpg","upload/gnxw/tp/1887626.jpg","upload/gnxw/tp/1895252.jpg"];
var info = ["","他们大都是是90后的新时代打工族。他们延续着父辈的打工生涯，却又比父辈多了一种渴望融入城市、立足城市的愿望。","","","","","","","",""];
var title = "农村来的年轻工人";
initDiv(document.getElementById('imagegroupjs_383007'),images,info,"",title);

document.getElementById('imagegroupjs_383007').innerHTML=document.getElementById('imagegroupjs_383007').innerHTML+"<script type='text/javascript'>	galleryScroll({		changeObj : '.bigimg_wrap .bigimg',		changeObj_wrap:'.bigimg_wrap',		thumbObj_wrap:'.img-thumbs',  		thumbObj : 'ul.img-thumb-list li',		botPrev : '.img_gallery_wrap .sprev',		botNext : '.img_gallery_wrap .snext',		description:'div.bigimg_description',		allowObj:'div.img_gallery_con',		imgcurNum:'span.img_gallery_num',		thumbPrev:'div.img_back',		thumbNext:'div.img_forward',		autoChangeObj: 'div.img_gallery_tipWrap span'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_383007').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_383007').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_383007').getElementsByTagName('script')[0].text);
}
},1000);
