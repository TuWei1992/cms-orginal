...
var images = ["http://i1.dds.com/cms/carmall/upload/resources/image/2015/05/27/31893.png","http://i3.dds.com/cms/carmall/upload/resources/image/2015/05/27/31894.png","http://i1.dds.com/cms/carmall/upload/resources/image/2015/05/27/31896.png","http://i3.dds.com/cms/carmall/upload/resources/image/2015/05/27/31897.png","http://i2.dds.com/cms/carmall/upload/resources/image/2015/05/27/31895.png"];
var info = ["适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV"];
var title = "现金购车";
var publishdate = "2015-05-27&#32;17:50:32";
var summary = "";
initDiv(document.getElementById('imagegroupjs_508418'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_508418').innerHTML=document.getElementById('imagegroupjs_508418').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_508418',		changeObj : '#imagegroupjs_508418 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_508418 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_508418 .img-thumbs',  		thumbObj : '#imagegroupjs_508418 ul.img-thumb-list li',		botPrev : '#imagegroupjs_508418 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_508418 .img_gallery_wrap .snext',		description:'#imagegroupjs_508418 div.bigimg_description',		allowObj:'#imagegroupjs_508418 div.img_gallery_con',		imgcurNum:'#imagegroupjs_508418 span.img_gallery_num',		thumbPrev:'#imagegroupjs_508418 div.img_back',		thumbNext:'#imagegroupjs_508418 div.img_forward',		autoChangeObj: '#imagegroupjs_508418 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_508418 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_508418').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_508418').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_508418').getElementsByTagName('script')[0].text);
}
},1000);
}())
