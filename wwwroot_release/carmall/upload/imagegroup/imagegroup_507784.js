...
var images = ["http://i3.dds.com/cms/carmall/upload/resources/image/2015/05/26/31860.png"];
var info = [""];
var title = "现金购车";
var publishdate = "2015-05-27&#32;15:51:34";
var summary = "";
initDiv(document.getElementById('imagegroupjs_507784'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_507784').innerHTML=document.getElementById('imagegroupjs_507784').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_507784',		changeObj : '#imagegroupjs_507784 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_507784 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_507784 .img-thumbs',  		thumbObj : '#imagegroupjs_507784 ul.img-thumb-list li',		botPrev : '#imagegroupjs_507784 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_507784 .img_gallery_wrap .snext',		description:'#imagegroupjs_507784 div.bigimg_description',		allowObj:'#imagegroupjs_507784 div.img_gallery_con',		imgcurNum:'#imagegroupjs_507784 span.img_gallery_num',		thumbPrev:'#imagegroupjs_507784 div.img_back',		thumbNext:'#imagegroupjs_507784 div.img_forward',		autoChangeObj: '#imagegroupjs_507784 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_507784 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_507784').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_507784').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_507784').getElementsByTagName('script')[0].text);
}
},1000);
}())
