...
var images = ["http://i2.dds.com/cms/carmall/upload/resources/image/2015/05/27/31883.png","http://i1.dds.com/cms/carmall/upload/resources/image/2015/05/27/31884.png","http://i2.dds.com/cms/carmall/upload/resources/image/2015/05/27/31886.png","http://i1.dds.com/cms/carmall/upload/resources/image/2015/05/27/31887.png","http://i3.dds.com/cms/carmall/upload/resources/image/2015/05/27/31885.png"];
var info = ["适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV"];
var title = "现金购车";
var publishdate = "2015-05-27&#32;17:00:48";
var summary = "";
initDiv(document.getElementById('imagegroupjs_508416'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_508416').innerHTML=document.getElementById('imagegroupjs_508416').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_508416',		changeObj : '#imagegroupjs_508416 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_508416 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_508416 .img-thumbs',  		thumbObj : '#imagegroupjs_508416 ul.img-thumb-list li',		botPrev : '#imagegroupjs_508416 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_508416 .img_gallery_wrap .snext',		description:'#imagegroupjs_508416 div.bigimg_description',		allowObj:'#imagegroupjs_508416 div.img_gallery_con',		imgcurNum:'#imagegroupjs_508416 span.img_gallery_num',		thumbPrev:'#imagegroupjs_508416 div.img_back',		thumbNext:'#imagegroupjs_508416 div.img_forward',		autoChangeObj: '#imagegroupjs_508416 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_508416 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_508416').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_508416').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_508416').getElementsByTagName('script')[0].text);
}
},1000);
}())
