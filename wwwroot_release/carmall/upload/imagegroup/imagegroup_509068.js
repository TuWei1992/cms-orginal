...
var images = ["http://i2.dds.com/cms/carmall/upload/resources/image/2015/05/29/31968.png","http://i1.dds.com/cms/carmall/upload/resources/image/2015/05/29/31969.png","http://i2.dds.com/cms/carmall/upload/resources/image/2015/05/29/31971.png","http://i1.dds.com/cms/carmall/upload/resources/image/2015/05/29/31972.png","http://i3.dds.com/cms/carmall/upload/resources/image/2015/05/29/31970.png"];
var info = ["适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV"];
var title = "现金购车";
var publishdate = "2015-05-29&#32;15:27:33";
var summary = "";
initDiv(document.getElementById('imagegroupjs_509068'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_509068').innerHTML=document.getElementById('imagegroupjs_509068').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_509068',		changeObj : '#imagegroupjs_509068 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_509068 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_509068 .img-thumbs',  		thumbObj : '#imagegroupjs_509068 ul.img-thumb-list li',		botPrev : '#imagegroupjs_509068 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_509068 .img_gallery_wrap .snext',		description:'#imagegroupjs_509068 div.bigimg_description',		allowObj:'#imagegroupjs_509068 div.img_gallery_con',		imgcurNum:'#imagegroupjs_509068 span.img_gallery_num',		thumbPrev:'#imagegroupjs_509068 div.img_back',		thumbNext:'#imagegroupjs_509068 div.img_forward',		autoChangeObj: '#imagegroupjs_509068 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_509068 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_509068').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_509068').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_509068').getElementsByTagName('script')[0].text);
}
},1000);
}())
