...
var images = ["http://i1.dds.com/cms/carmall/upload/resources/image/2015/05/29/31948.png","http://i3.dds.com/cms/carmall/upload/resources/image/2015/05/29/31949.png","http://i1.dds.com/cms/carmall/upload/resources/image/2015/05/29/31951.png","http://i3.dds.com/cms/carmall/upload/resources/image/2015/05/29/31952.png","http://i2.dds.com/cms/carmall/upload/resources/image/2015/05/29/31950.png"];
var info = ["适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV"];
var title = "现金购车";
var publishdate = "2015-05-29&#32;15:17:49";
var summary = "";
initDiv(document.getElementById('imagegroupjs_509041'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_509041').innerHTML=document.getElementById('imagegroupjs_509041').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_509041',		changeObj : '#imagegroupjs_509041 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_509041 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_509041 .img-thumbs',  		thumbObj : '#imagegroupjs_509041 ul.img-thumb-list li',		botPrev : '#imagegroupjs_509041 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_509041 .img_gallery_wrap .snext',		description:'#imagegroupjs_509041 div.bigimg_description',		allowObj:'#imagegroupjs_509041 div.img_gallery_con',		imgcurNum:'#imagegroupjs_509041 span.img_gallery_num',		thumbPrev:'#imagegroupjs_509041 div.img_back',		thumbNext:'#imagegroupjs_509041 div.img_forward',		autoChangeObj: '#imagegroupjs_509041 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_509041 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_509041').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_509041').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_509041').getElementsByTagName('script')[0].text);
}
},1000);
}())
