...
var images = ["http://i2.dds.com/cms/carmall/upload/resources/image/2015/05/29/31953.png","http://i1.dds.com/cms/carmall/upload/resources/image/2015/05/29/31954.png","http://i2.dds.com/cms/carmall/upload/resources/image/2015/05/29/31956.png","http://i1.dds.com/cms/carmall/upload/resources/image/2015/05/29/31957.png","http://i3.dds.com/cms/carmall/upload/resources/image/2015/05/29/31955.png"];
var info = ["适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车"];
var title = "分期购车";
var publishdate = "2015-05-29&#32;15:17:49";
var summary = "";
initDiv(document.getElementById('imagegroupjs_509042'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_509042').innerHTML=document.getElementById('imagegroupjs_509042').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_509042',		changeObj : '#imagegroupjs_509042 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_509042 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_509042 .img-thumbs',  		thumbObj : '#imagegroupjs_509042 ul.img-thumb-list li',		botPrev : '#imagegroupjs_509042 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_509042 .img_gallery_wrap .snext',		description:'#imagegroupjs_509042 div.bigimg_description',		allowObj:'#imagegroupjs_509042 div.img_gallery_con',		imgcurNum:'#imagegroupjs_509042 span.img_gallery_num',		thumbPrev:'#imagegroupjs_509042 div.img_back',		thumbNext:'#imagegroupjs_509042 div.img_forward',		autoChangeObj: '#imagegroupjs_509042 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_509042 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_509042').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_509042').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_509042').getElementsByTagName('script')[0].text);
}
},1000);
}())
