...
var images = ["http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25394.png","http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25395.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25396.png","http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25397.png","http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25392.png"];
var info = ["适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车"];
var title = "分期购车";
var publishdate = "2015-06-04&#32;14:42:19";
var summary = "";
initDiv(document.getElementById('imagegroupjs_490921'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_490921').innerHTML=document.getElementById('imagegroupjs_490921').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_490921',		changeObj : '#imagegroupjs_490921 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_490921 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_490921 .img-thumbs',  		thumbObj : '#imagegroupjs_490921 ul.img-thumb-list li',		botPrev : '#imagegroupjs_490921 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_490921 .img_gallery_wrap .snext',		description:'#imagegroupjs_490921 div.bigimg_description',		allowObj:'#imagegroupjs_490921 div.img_gallery_con',		imgcurNum:'#imagegroupjs_490921 span.img_gallery_num',		thumbPrev:'#imagegroupjs_490921 div.img_back',		thumbNext:'#imagegroupjs_490921 div.img_forward',		autoChangeObj: '#imagegroupjs_490921 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_490921 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_490921').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_490921').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_490921').getElementsByTagName('script')[0].text);
}
},1000);
}())
