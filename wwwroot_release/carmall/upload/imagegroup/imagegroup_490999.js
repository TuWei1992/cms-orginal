...
var images = ["http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25423.png","http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25424.png","http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25425.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25426.png","http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25427.png"];
var info = ["适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV"];
var title = "现金购车";
var publishdate = "2015-06-04&#32;16:11:19";
var summary = "";
initDiv(document.getElementById('imagegroupjs_490999'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_490999').innerHTML=document.getElementById('imagegroupjs_490999').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_490999',		changeObj : '#imagegroupjs_490999 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_490999 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_490999 .img-thumbs',  		thumbObj : '#imagegroupjs_490999 ul.img-thumb-list li',		botPrev : '#imagegroupjs_490999 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_490999 .img_gallery_wrap .snext',		description:'#imagegroupjs_490999 div.bigimg_description',		allowObj:'#imagegroupjs_490999 div.img_gallery_con',		imgcurNum:'#imagegroupjs_490999 span.img_gallery_num',		thumbPrev:'#imagegroupjs_490999 div.img_back',		thumbNext:'#imagegroupjs_490999 div.img_forward',		autoChangeObj: '#imagegroupjs_490999 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_490999 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_490999').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_490999').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_490999').getElementsByTagName('script')[0].text);
}
},1000);
}())
