...
var images = ["http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25404.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25405.png","http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25406.png","http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25407.png","http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25403.png"];
var info = ["适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车"];
var title = "分期购车";
var publishdate = "2015-06-04&#32;16:11:26";
var summary = "";
initDiv(document.getElementById('imagegroupjs_490995'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_490995').innerHTML=document.getElementById('imagegroupjs_490995').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_490995',		changeObj : '#imagegroupjs_490995 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_490995 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_490995 .img-thumbs',  		thumbObj : '#imagegroupjs_490995 ul.img-thumb-list li',		botPrev : '#imagegroupjs_490995 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_490995 .img_gallery_wrap .snext',		description:'#imagegroupjs_490995 div.bigimg_description',		allowObj:'#imagegroupjs_490995 div.img_gallery_con',		imgcurNum:'#imagegroupjs_490995 span.img_gallery_num',		thumbPrev:'#imagegroupjs_490995 div.img_back',		thumbNext:'#imagegroupjs_490995 div.img_forward',		autoChangeObj: '#imagegroupjs_490995 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_490995 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_490995').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_490995').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_490995').getElementsByTagName('script')[0].text);
}
},1000);
}())
