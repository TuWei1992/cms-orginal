...
var images = ["http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25439.png","http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25440.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25441.png","http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25442.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25438.png"];
var info = ["适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车"];
var title = "分期购车";
var publishdate = "2015-06-04&#32;16:42:43";
var summary = "";
initDiv(document.getElementById('imagegroupjs_491055'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_491055').innerHTML=document.getElementById('imagegroupjs_491055').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_491055',		changeObj : '#imagegroupjs_491055 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_491055 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_491055 .img-thumbs',  		thumbObj : '#imagegroupjs_491055 ul.img-thumb-list li',		botPrev : '#imagegroupjs_491055 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_491055 .img_gallery_wrap .snext',		description:'#imagegroupjs_491055 div.bigimg_description',		allowObj:'#imagegroupjs_491055 div.img_gallery_con',		imgcurNum:'#imagegroupjs_491055 span.img_gallery_num',		thumbPrev:'#imagegroupjs_491055 div.img_back',		thumbNext:'#imagegroupjs_491055 div.img_forward',		autoChangeObj: '#imagegroupjs_491055 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_491055 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_491055').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_491055').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_491055').getElementsByTagName('script')[0].text);
}
},1000);
}())
