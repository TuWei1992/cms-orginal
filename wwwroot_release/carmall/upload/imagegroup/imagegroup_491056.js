...
var images = ["http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25443.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25444.png","http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25445.png","http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25446.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25447.png"];
var info = ["适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV"];
var title = "现金购车";
var publishdate = "2015-06-04&#32;16:42:39";
var summary = "";
initDiv(document.getElementById('imagegroupjs_491056'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_491056').innerHTML=document.getElementById('imagegroupjs_491056').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_491056',		changeObj : '#imagegroupjs_491056 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_491056 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_491056 .img-thumbs',  		thumbObj : '#imagegroupjs_491056 ul.img-thumb-list li',		botPrev : '#imagegroupjs_491056 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_491056 .img_gallery_wrap .snext',		description:'#imagegroupjs_491056 div.bigimg_description',		allowObj:'#imagegroupjs_491056 div.img_gallery_con',		imgcurNum:'#imagegroupjs_491056 span.img_gallery_num',		thumbPrev:'#imagegroupjs_491056 div.img_back',		thumbNext:'#imagegroupjs_491056 div.img_forward',		autoChangeObj: '#imagegroupjs_491056 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_491056 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_491056').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_491056').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_491056').getElementsByTagName('script')[0].text);
}
},1000);
}())
