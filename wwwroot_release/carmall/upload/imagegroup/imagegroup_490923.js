...
var images = ["http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25398.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25399.png","http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25400.png","http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25401.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25402.png"];
var info = ["适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV"];
var title = "现金购车";
var publishdate = "2015-06-04&#32;14:46:38";
var summary = "";
initDiv(document.getElementById('imagegroupjs_490923'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_490923').innerHTML=document.getElementById('imagegroupjs_490923').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_490923',		changeObj : '#imagegroupjs_490923 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_490923 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_490923 .img-thumbs',  		thumbObj : '#imagegroupjs_490923 ul.img-thumb-list li',		botPrev : '#imagegroupjs_490923 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_490923 .img_gallery_wrap .snext',		description:'#imagegroupjs_490923 div.bigimg_description',		allowObj:'#imagegroupjs_490923 div.img_gallery_con',		imgcurNum:'#imagegroupjs_490923 span.img_gallery_num',		thumbPrev:'#imagegroupjs_490923 div.img_back',		thumbNext:'#imagegroupjs_490923 div.img_forward',		autoChangeObj: '#imagegroupjs_490923 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_490923 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_490923').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_490923').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_490923').getElementsByTagName('script')[0].text);
}
},1000);
}())
