...
checkloadjscssfile("http://i1.dds.com/css/img_gallery.css", "css") // success
checkloadjscssfile("http://i3.dds.com/js/imggallery.js", "js") // success
...
var images = ["http://i2.dds.com/upload/resources/image/2015/05/25/31848.jpg","http://i3.dds.com/upload/resources/image/2015/05/25/31849.jpg","http://i1.dds.com/upload/resources/image/2015/05/25/31850.jpg","http://i1.dds.com/upload/resources/image/2015/05/26/31857.jpg","http://i3.dds.com/upload/resources/image/2015/05/26/31858.jpg","http://i2.dds.com/upload/resources/image/2015/05/26/31859.jpg"];
var info = ["","","","","",""];
var title = "现金购车";
var publishdate = "2015-05-26&#32;10:01:21";
var summary = "";
initDiv(document.getElementById('imagegroupjs_507607'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_507607').innerHTML=document.getElementById('imagegroupjs_507607').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_507607',		changeObj : '#imagegroupjs_507607 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_507607 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_507607 .img-thumbs',  		thumbObj : '#imagegroupjs_507607 ul.img-thumb-list li',		botPrev : '#imagegroupjs_507607 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_507607 .img_gallery_wrap .snext',		description:'#imagegroupjs_507607 div.bigimg_description',		allowObj:'#imagegroupjs_507607 div.img_gallery_con',		imgcurNum:'#imagegroupjs_507607 span.img_gallery_num',		thumbPrev:'#imagegroupjs_507607 div.img_back',		thumbNext:'#imagegroupjs_507607 div.img_forward',		autoChangeObj: '#imagegroupjs_507607 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_507607 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_507607').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_507607').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_507607').getElementsByTagName('script')[0].text);
}
},1000);
}())
