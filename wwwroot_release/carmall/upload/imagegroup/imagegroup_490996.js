...
var images = ["http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25409.png","http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25410.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25411.png","http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25412.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25408.png"];
var info = ["适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车"];
var title = "分期购车";
var publishdate = "2015-06-04&#32;16:11:19";
var summary = "";
initDiv(document.getElementById('imagegroupjs_490996'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_490996').innerHTML=document.getElementById('imagegroupjs_490996').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_490996',		changeObj : '#imagegroupjs_490996 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_490996 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_490996 .img-thumbs',  		thumbObj : '#imagegroupjs_490996 ul.img-thumb-list li',		botPrev : '#imagegroupjs_490996 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_490996 .img_gallery_wrap .snext',		description:'#imagegroupjs_490996 div.bigimg_description',		allowObj:'#imagegroupjs_490996 div.img_gallery_con',		imgcurNum:'#imagegroupjs_490996 span.img_gallery_num',		thumbPrev:'#imagegroupjs_490996 div.img_back',		thumbNext:'#imagegroupjs_490996 div.img_forward',		autoChangeObj: '#imagegroupjs_490996 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_490996 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_490996').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_490996').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_490996').getElementsByTagName('script')[0].text);
}
},1000);
}())
