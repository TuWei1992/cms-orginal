...
checkloadjscssfile("http://i1.img.com//cms/carmall/css/img_gallery.css", "css") // success
checkloadjscssfile("http://i3.img.com//cms/carmall/js/imggallery.js", "js") // success
...
var images = ["http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25418.png","http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25419.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25420.png","http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25421.png","http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25422.png"];
var info = ["适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV"];
var title = "现金购车";
var publishdate = "2015-06-04&#32;16:11:26";
var summary = "";
initDiv(document.getElementById('imagegroupjs_490998'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_490998').innerHTML=document.getElementById('imagegroupjs_490998').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_490998',		changeObj : '#imagegroupjs_490998 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_490998 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_490998 .img-thumbs',  		thumbObj : '#imagegroupjs_490998 ul.img-thumb-list li',		botPrev : '#imagegroupjs_490998 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_490998 .img_gallery_wrap .snext',		description:'#imagegroupjs_490998 div.bigimg_description',		allowObj:'#imagegroupjs_490998 div.img_gallery_con',		imgcurNum:'#imagegroupjs_490998 span.img_gallery_num',		thumbPrev:'#imagegroupjs_490998 div.img_back',		thumbNext:'#imagegroupjs_490998 div.img_forward',		autoChangeObj: '#imagegroupjs_490998 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_490998 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_490998').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_490998').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_490998').getElementsByTagName('script')[0].text);
}
},1000);
}())
