...
var images = ["http://i1.dds.com/cms/carmall/upload/resources/image/2015/05/29/31963.png","http://i3.dds.com/cms/carmall/upload/resources/image/2015/05/29/31964.png","http://i1.dds.com/cms/carmall/upload/resources/image/2015/05/29/31966.png","http://i3.dds.com/cms/carmall/upload/resources/image/2015/05/29/31967.png","http://i2.dds.com/cms/carmall/upload/resources/image/2015/05/29/31965.png"];
var info = ["适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车"];
var title = "分期购车";
var publishdate = "2015-05-29&#32;15:19:57";
var summary = "";
initDiv(document.getElementById('imagegroupjs_509051'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_509051').innerHTML=document.getElementById('imagegroupjs_509051').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_509051',		changeObj : '#imagegroupjs_509051 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_509051 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_509051 .img-thumbs',  		thumbObj : '#imagegroupjs_509051 ul.img-thumb-list li',		botPrev : '#imagegroupjs_509051 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_509051 .img_gallery_wrap .snext',		description:'#imagegroupjs_509051 div.bigimg_description',		allowObj:'#imagegroupjs_509051 div.img_gallery_con',		imgcurNum:'#imagegroupjs_509051 span.img_gallery_num',		thumbPrev:'#imagegroupjs_509051 div.img_back',		thumbNext:'#imagegroupjs_509051 div.img_forward',		autoChangeObj: '#imagegroupjs_509051 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_509051 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_509051').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_509051').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_509051').getElementsByTagName('script')[0].text);
}
},1000);
}())
