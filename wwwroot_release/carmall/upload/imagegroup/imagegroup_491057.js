...
var images = ["http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25448.png","http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25449.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25450.png","http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25451.png","http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25452.png"];
var info = ["适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV"];
var title = "现金购车";
var publishdate = "2015-06-04&#32;16:42:43";
var summary = "";
initDiv(document.getElementById('imagegroupjs_491057'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_491057').innerHTML=document.getElementById('imagegroupjs_491057').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_491057',		changeObj : '#imagegroupjs_491057 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_491057 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_491057 .img-thumbs',  		thumbObj : '#imagegroupjs_491057 ul.img-thumb-list li',		botPrev : '#imagegroupjs_491057 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_491057 .img_gallery_wrap .snext',		description:'#imagegroupjs_491057 div.bigimg_description',		allowObj:'#imagegroupjs_491057 div.img_gallery_con',		imgcurNum:'#imagegroupjs_491057 span.img_gallery_num',		thumbPrev:'#imagegroupjs_491057 div.img_back',		thumbNext:'#imagegroupjs_491057 div.img_forward',		autoChangeObj: '#imagegroupjs_491057 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_491057 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_491057').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_491057').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_491057').getElementsByTagName('script')[0].text);
}
},1000);
}())
