...
var images = ["http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25434.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25435.png","http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25436.png","http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25437.png","http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25433.png"];
var info = ["适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车"];
var title = "分期购车";
var publishdate = "2015-06-04&#32;16:42:39";
var summary = "";
initDiv(document.getElementById('imagegroupjs_491054'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_491054').innerHTML=document.getElementById('imagegroupjs_491054').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_491054',		changeObj : '#imagegroupjs_491054 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_491054 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_491054 .img-thumbs',  		thumbObj : '#imagegroupjs_491054 ul.img-thumb-list li',		botPrev : '#imagegroupjs_491054 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_491054 .img_gallery_wrap .snext',		description:'#imagegroupjs_491054 div.bigimg_description',		allowObj:'#imagegroupjs_491054 div.img_gallery_con',		imgcurNum:'#imagegroupjs_491054 span.img_gallery_num',		thumbPrev:'#imagegroupjs_491054 div.img_back',		thumbNext:'#imagegroupjs_491054 div.img_forward',		autoChangeObj: '#imagegroupjs_491054 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_491054 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_491054').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_491054').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_491054').getElementsByTagName('script')[0].text);
}
},1000);
}())
