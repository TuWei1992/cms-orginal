...
var images = ["http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25428.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25429.png","http://i2.img.com//cms/carmall/upload/resources/image/2015/06/04/25430.png","http://i1.img.com//cms/carmall/upload/resources/image/2015/06/04/25431.png","http://i3.img.com//cms/carmall/upload/resources/image/2015/06/04/25432.png"];
var info = ["适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV","适合过日子的SUV"];
var title = "现金购车";
var publishdate = "2015-06-04&#32;16:11:07";
var summary = "";
initDiv(document.getElementById('imagegroupjs_491000'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_491000').innerHTML=document.getElementById('imagegroupjs_491000').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_491000',		changeObj : '#imagegroupjs_491000 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_491000 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_491000 .img-thumbs',  		thumbObj : '#imagegroupjs_491000 ul.img-thumb-list li',		botPrev : '#imagegroupjs_491000 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_491000 .img_gallery_wrap .snext',		description:'#imagegroupjs_491000 div.bigimg_description',		allowObj:'#imagegroupjs_491000 div.img_gallery_con',		imgcurNum:'#imagegroupjs_491000 span.img_gallery_num',		thumbPrev:'#imagegroupjs_491000 div.img_back',		thumbNext:'#imagegroupjs_491000 div.img_forward',		autoChangeObj: '#imagegroupjs_491000 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_491000 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_491000').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_491000').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_491000').getElementsByTagName('script')[0].text);
}
},1000);
}())
