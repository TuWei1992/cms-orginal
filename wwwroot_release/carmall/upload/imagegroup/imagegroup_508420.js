...
var images = ["http://i3.dds.com/cms/carmall/upload/resources/image/2015/05/27/31903.png","http://i2.dds.com/cms/carmall/upload/resources/image/2015/05/27/31904.png","http://i3.dds.com/cms/carmall/upload/resources/image/2015/05/27/31906.png","http://i2.dds.com/cms/carmall/upload/resources/image/2015/05/27/31907.png","http://i1.dds.com/cms/carmall/upload/resources/image/2015/05/27/31905.png"];
var info = ["适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车","适合过日子的车"];
var title = "分期购车";
var publishdate = "2015-05-27&#32;17:00:48";
var summary = "";
initDiv(document.getElementById('imagegroupjs_508420'),images,info,"",title,publishdate,summary);

document.getElementById('imagegroupjs_508420').innerHTML=document.getElementById('imagegroupjs_508420').innerHTML+"<script type='text/javascript'>	galleryScroll({imgMaxHeight:imgMaxHeight,containerId:'imagegroupjs_508420',		changeObj : '#imagegroupjs_508420 .bigimg_wrap .bigimg',		changeObj_wrap:'#imagegroupjs_508420 .bigimg_wrap',		thumbObj_wrap:'#imagegroupjs_508420 .img-thumbs',  		thumbObj : '#imagegroupjs_508420 ul.img-thumb-list li',		botPrev : '#imagegroupjs_508420 .img_gallery_wrap .sprev',		botNext : '#imagegroupjs_508420 .img_gallery_wrap .snext',		description:'#imagegroupjs_508420 div.bigimg_description',		allowObj:'#imagegroupjs_508420 div.img_gallery_con',		imgcurNum:'#imagegroupjs_508420 span.img_gallery_num',		thumbPrev:'#imagegroupjs_508420 div.img_back',		thumbNext:'#imagegroupjs_508420 div.img_forward',		autoChangeObj: '#imagegroupjs_508420 div.img_gallery_tipWrap span',		lookBigImgObj: '#imagegroupjs_508420 div.img_gallery_tipWrap a'	});</script>";

setTimeout(function(){
if(document.getElementById('imagegroupjs_508420').getElementsByTagName('script')[1]){
	eval(document.getElementById('imagegroupjs_508420').getElementsByTagName('script')[1].text);
}else{
	eval(document.getElementById('imagegroupjs_508420').getElementsByTagName('script')[0].text);
}
},1000);
}())
